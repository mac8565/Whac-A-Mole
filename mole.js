...
function setGame() {
    ...
    for (let i = 0; i < 9; i++) { //i goes to 0 to 8, stops at 9
        //<div id="0-8"></div>
...
//Mole image design by Freepik, Angry Plant design by Freepik, Gaming image design by Lucie Liz